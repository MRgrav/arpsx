...
import PdfFile from '@/pages/AdmissionProcedure/AdmissionProcedure.pdf';
...
onMounted(async () => {
    try {
        const response = await fetch('/api/modules/admission_procedure');
...
<template>
    <AppLayout>
        <PageHeadIndi heading="Admission Procedure" />
